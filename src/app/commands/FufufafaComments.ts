...
import {getFufufafaCommentById, getRandomFufufafaComment} from '../../shared/utils/getFufufafaComments.js';
...
export class FufufafaComments extends CommandInterface {
    static commandInfo: CommandInfo = {
        name: 'fufufafa',
        description: 'Komentar random dari akun Kaskus Fufufafa. (Total 699 komentar)',
        helpText: `*Penggunaan:*
    ...
    async handleCommand(
        ...
        try {
            ...
            const caption = `${fufufafaComments.content}\n\nPosted on ${new Date(
                ...
                fufufafaComments.id
            }\n\nKirim ${BotConfig.prefix}fufufafa ${fufufafaComments.id} untuk mendapatkan gambar ini kembali`;
